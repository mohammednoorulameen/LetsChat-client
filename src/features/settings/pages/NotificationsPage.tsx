...
import type{ NotificationSection } from '../settings_types'

// 🔷 Define a type for toggle-only settings

// 🔷 Static data with type
const notificationData: NotificationSection[] = [
  {
